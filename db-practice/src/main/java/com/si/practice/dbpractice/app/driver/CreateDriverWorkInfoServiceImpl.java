...
@Slf4j
@Service
public class CreateDriverWorkInfoServiceImpl implements CreateDriverWorkInfoService {
    ...
    @Override
    public Long create(DriverWorkInfoRequest request) {


        DriverWorkInfoDTO workInfoDTO =  new DriverWorkInfoDTO();
        BeanUtils.copyProperties(request, workInfoDTO);
        return driverWorkInfoManager.addDriverWorkInfo(workInfoDTO);
    }
}
